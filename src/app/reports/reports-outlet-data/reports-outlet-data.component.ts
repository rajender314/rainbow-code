...
@Component({
  selector: 'adj-reports-outlet-data',
  templateUrl: './reports-outlet-data.component.html',
  styleUrls: ['./reports-outlet-data.component.scss'],
})
export class ReportsOutletDataComponent implements OnInit {
  ...
  getSummaryTableData() {
    ...
    this.baseAPI.executeGet({
      url: apiDirectory.outletIssueSummary,
      params: params
    }).subscribe(response => {
