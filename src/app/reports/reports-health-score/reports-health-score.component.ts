...
@Component({
  selector: 'adj-reports-health-score',
  templateUrl: './reports-health-score.component.html',
  styleUrls: ['./reports-health-score.component.scss'],
})
export class ReportsHealthScoreComponent implements OnInit {
  ...
  getSummaryTableData() {
    ...
    this.baseAPI.executeGet({
      url: apiDirectory.healthScoreSummary,
      params: params
    }).subscribe(response => {
